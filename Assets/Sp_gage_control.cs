...
public class Sp_gage_control : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        sp_one_mater_x = sp_gage_scale_orign_x / Player_move.P_SP;
    ...
    void Update()
    {
        ...
        transform.localScale = new Vector3(sp_one_mater_x * player_script.p_sp, sp_gage_scale_orign_y, 0);
    }
